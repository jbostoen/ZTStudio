        ...
        Private Sub MyApplication_UnhandledException(sender As Object, e As ApplicationServices.UnhandledExceptionEventArgs) Handles Me.UnhandledException
            ...
            Try
                ...
                Dim StrMessage As String = "" &
                    "Sorry, but an unexpected error occurred that was not handled anywhere else in " & Me.Info.ProductName & "." & vbCrLf &
                    ...
                    "Do you want to try to continue working? Choosing ""No"" will close " & Me.Info.ProductName & "."
